    ...
    <div style={{ width: '100vw', height: '100vh', background: '#0d0d1a' }}>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Built with real specs: 1480mm wheelbase &bull; 1340cc inline-4 &bull; 17&quot; wheels &bull; Full fairing &bull; CSG boolean geometry
        </p>
      </div>
      ...
      >
        <Suspense fallback={null}>
          ...
          <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0, 0]} receiveShadow>
            ...
            <meshStandardMaterial color="#181828" roughness={0.85} metalness={0.15} />
          </mesh>
          ...
          {/* Grid */}
          <gridHelper args={[8, 40, '#222244', '#1a1a33']} position={[0, 0.001, 0]} />
