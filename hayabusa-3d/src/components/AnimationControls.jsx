...
const SUZUKI_BLUE_LIGHT = '#4488cc'
const SUZUKI_BLUE_DIM = '#003DA544'
const SUZUKI_BLUE_BG = '#003DA533'
...
const btnStyle = (active) => ({
  ...
  border: 'none',
  borderRadius: '6px',
  background: active ? SUZUKI_BLUE_DIM : '#ffffff0a',
  color: active ? SUZUKI_BLUE_LIGHT : '#aaa',
  cursor: 'pointer',
  fontSize: '13px',
  fontFamily: 'Arial, sans-serif',
  textAlign: 'left',
  transition: 'all 0.2s',
  outline: active ? `1px solid ${SUZUKI_BLUE}66` : '1px solid transparent',
})
            ...
            <div key={key} style={{ marginBottom: '3px' }}>
              ...
              >
                ...
                <span style={{
                  ...
                  padding: '2px 6px',
                  borderRadius: '3px',
                  background: (invert ? !active : active) ? SUZUKI_BLUE_BG : '#ffffff08',
                  color: (invert ? !active : active) ? SUZUKI_BLUE_LIGHT : '#666',
                }}>
          ...
          <div style={{ marginTop: '6px', borderTop: '1px solid #333', paddingTop: '8px', display: 'flex', gap: '4px', padding: '8px 6px 2px' }}>
            <button
              ...
              style={{
                flex: 1,
                padding: '6px',
                border: `1px solid ${SUZUKI_BLUE}55`,
                borderRadius: '5px',
                background: '#ffffff08',
                color: '#ccc',
                cursor: 'pointer',
