...
// KTM 390 Duke: 43 HP @ 9000 RPM, redline ~10500 RPM
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: engineRunning ? '#FF6600' : '#444',
            fontSize: '11px',
            fontFamily: 'monospace',
            fontWeight: 'bold',
          }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: '100%',
            background: displayRPM > 8000 ? '#ff4444' : displayRPM > 5000 ? '#FF6600' : '#ff8833',
