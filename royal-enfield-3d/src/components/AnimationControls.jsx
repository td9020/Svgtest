...
const btnStyle = (active) => ({
  ...
  border: 'none',
  borderRadius: '6px',
  background: active ? `${RE_GREEN}66` : '#ffffff0a',
  color: active ? RE_GREEN_LIGHT : '#aaa',
  cursor: 'pointer',
  fontSize: '13px',
  fontFamily: 'Arial, sans-serif',
  textAlign: 'left',
  transition: 'all 0.2s',
  outline: active ? `1px solid ${RE_GREEN}88` : '1px solid transparent',
})
            ...
            <div key={key} style={{ marginBottom: '3px' }}>
              ...
              >
                ...
                <span style={{
                  ...
                  padding: '2px 6px',
                  borderRadius: '3px',
                  background: (invert ? !active : active) ? `${RE_GREEN}44` : '#ffffff08',
                  color: (invert ? !active : active) ? RE_GREEN_LIGHT : '#666',
                }}>
