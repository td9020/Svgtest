 ...
 *   <CSGMesh
 *     operation="subtract"
 *     geometryA={new THREE.BoxGeometry(1,1,1)}
 *     geometryB={new THREE.CylinderGeometry(0.3,0.3,2)}
 *     transformB={{ position: [0,0,0], rotation: [Math.PI/2, 0, 0] }}
